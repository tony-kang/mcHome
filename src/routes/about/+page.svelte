	...
	<section class="values-section">
		<div class="container">
			<div class="section-header">
				<h2>핵심가치 Core Values – RE:GIP</h2>
			</div>

			<div class="values-grid">
				<div class="value-card">
					<div class="value-icon">🎯</div>
					<h3>Responsibility | 책임</h3>
					<p>재능은 맡겨진 자산, 우리는 그것을 책임 있게 관리한다.</p>
				</div>
				<div class="value-card">
					<div class="value-icon">💝</div>
					<h3>Empathy | 공감</h3>
		...
		<div class="container">
			<div class="ceo-content">
				<div class="ceo-header">
					<h2>대표인사말</h2>
					<div class="ceo-info">
						<div class="ceo-name">박제희</div>
						<div class="ceo-title">마인드코딩 대표</div>
					</div>
				</div>
